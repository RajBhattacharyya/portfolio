...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-20 bg-white dark:bg-dark-800 transition-colors duration-300">
            ...
            <motion.div className="space-y-6" variants={itemVariants}>
              {contactInfo.map((contact, index) => (
                ...
                >
                  ...
                  >
                    <contact.icon size={20} className="text-primary-600 dark:text-primary-400" />
                  </motion.div>
                  <div>
                    <p className="text-sm text-neutral-500 dark:text-neutral-400">{contact.label}</p>
